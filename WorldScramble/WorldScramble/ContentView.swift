...
struct ContentView: View {
    ...
    func addNewWord() {
        ...
        guard wordHasBennUsed(word: answer) else {
            wordError(title: "Word used already", message: "Be more original")
            return
        }
        
        guard isPossible(word: answer) else {
            wordError(title: "Word not possible", message: "You cannot crate this word form \(rootWord)")
            return
        }
    ...
    func startGame() {
        ...
        fatalError("Oh no couldn't load words.")
    }
    
    func wordHasBennUsed(word: String) -> Bool {
